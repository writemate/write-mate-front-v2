...
export const deleteChapter =
  (plotId: string, chapterId: string) => async () => {
...
export const updateChapterName =
  (plotId: string, chapterId: string) => async (chapter_name: string) => {
 ...
 */
export const updateChapterDescription =
  (plotId: string, chapterId: string) =>
 ...
 * @param is_folded
 */
export const updateChapterFoldAll =
  (plotId: string) => async (is_folded: boolean) => {
    const response = await axiosInstance.patch<void>(
 ...
 * @param is_folded
 */
export const updateChapterFoldForLocal =
  (plotId: string, chapterId: string) => async (is_folded: boolean) => {
    const response = await axiosInstance.patch<void>(
...
export const deleteEvent =
  (chapterId: string, peventId: string) => async () => {
    const response = await axiosInstance.delete<void>(
...
export const updateEventName =
  (chapterId: string, peventId: string) => async (event_name: string) => {
    const response = await axiosInstance.patch<void>(
...
export const updateEventDescription =
  (chapterId: string, peventId: string) =>
...
export const addCharacter =
  (chapterId: string, peventId: string) => async (characterId: string) => {
