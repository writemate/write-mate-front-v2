    ...
    return (
        <CoverContainer>
            ...
            <CoverContentsContainer>
                {isDeletable&&<DeleteButton onClick={onClickDeleteCharacter} style={{marginLeft:"auto",marginBottom:"auto"}}>삭제하기</DeleteButton>}
                ...
                <Input placeholder="작품 속 인물의 역할을 적어주세요" onChange={onChangeRole} defaultValue={role} disabled={isLoading}/>
            </CoverContentsContainer>
        </CoverContainer>
    );
}
